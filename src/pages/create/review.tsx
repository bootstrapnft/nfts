        ...
        >
            <form action="#" autoComplete="off">
                ...
                <dl className="dark:text-gray-300 text-lm-gray-700 mt-8">
                    ...
                    <div className="sm:flex sm:justify-between mt-4">
                        <dt className="mr-4 text-sm uppercase">
                            Token Standard
                        </dt>
                ...
                <div className="mt-8 p-4 border border-orange-500 bg-orange-800 rounded-md text-sm">
                    Please be aware that bootstrapping a successful vault
                    requires up to 3 transactions — one to create the vault, one
                    to add inventory (NFTs) and liquidity (ETH), and one to
