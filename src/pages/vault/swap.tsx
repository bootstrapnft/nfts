            ...
            {swapSwitchType === "to" &&
              mints.map((item, index) => (
                <VaultCard
                  ...
                  callback={(item: any) => selectReceiveTokenId(item)}
                />
              ))}
          </div>
        </section>
          ...
          <div className="md:block md:sticky md:top-18 hidden">
            <div className="block p-6 sm:p-10 md:p-6 md:mb-8">
              ...
              >
                {selectFromIds.length === 0 && (
                  <div
                    ...
                    onClick={() => setSwapSwitchType("from")}
                  >
              ...
              <div className="text-center">
                <button className="btn-primary mt-6 px-6 py-3" onClick={swap}>
                  Swap NFT
                </button>
              </div>
            </div>
