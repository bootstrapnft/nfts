        ...
        >
            <div className="flex items-center">
                ...
                <div className="flex items-center md:hidden ml-auto">
                    {/*<button className="inline-flex items-center justify-center outline-none font-medium rounded-md */}
                    {/*break-word hover:outline focus:outline-none focus:ring-1 focus:ring-opacity-75 py-1.5 px-2 */}
                    {/*text-xs bg-white text-gray-900 hover:bg-gray-100 focus:ring-gray-300 dark:bg-gray-700 */}
                    {/*dark:text-white text-sm p-2 rounded">*/}
                    {/*    Filters*/}
                    {/*</button>*/}
                </div>
            </div>
